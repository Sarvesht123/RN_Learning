  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <RequestState loading={categoryResult.loading || productResult.loading} error={categoryResult.error || productResult.error} retry={() => { categoryResult.retry(); productResult.retry(); }} />
