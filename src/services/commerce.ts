...
type MobileApiProduct = { uid: string; sku: string; name: string; brand?: string; product_country?: string; size?: string; stock_status: string; am_product_label?: string; description?: string; small_image?: string; price: number; regular_price: number; discount_percent: number };
...
const PRODUCT_FIELDS = `uid sku name brand product_country size stock_status am_product_label description small_image price regular_price discount_percent`;
